...
$string['privacy:metadata:local_coursetransfermanager_executions'] = 'Ejecuciones de las tareas de transferencia. Se guarda una referencia de usuario cuando alguien cancela un borrado remoto programado.';
$string['privacy:metadata:local_coursetransfermanager_executions:deletecancelledat'] = 'Cuándo se canceló el borrado programado.';
$string['privacy:metadata:local_coursetransfermanager_executions:deletecancelledby'] = 'Usuario que canceló el borrado programado en la plataforma origen.';
$string['privacy:metadata:local_coursetransfermanager_prune'] = 'Candidatos al podado del archivo. Se guarda una referencia de usuario cuando alguien excluye una categoría del podado.';
$string['privacy:metadata:local_coursetransfermanager_prune:excludedat'] = 'Cuándo se excluyó la categoría del podado.';
$string['privacy:metadata:local_coursetransfermanager_prune:excludedby'] = 'Usuario que excluyó la categoría del podado.';
$string['privacy:metadata:local_coursetransfermanager_tasks'] = 'Tareas de transferencia configuradas en este sitio. Se guardan referencias de usuario para saber quién creó cada tarea y quién recibe sus avisos.';
$string['privacy:metadata:local_coursetransfermanager_tasks:notifyrecipients'] = 'Usuarios adicionales que reciben los avisos de esta tarea.';
$string['privacy:metadata:local_coursetransfermanager_tasks:usercreated'] = 'Usuario que creó la tarea. Recibe los avisos de su ciclo de vida.';

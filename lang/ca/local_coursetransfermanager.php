...
$string['privacy:metadata:local_coursetransfermanager_executions'] = 'Execucions de les tasques de transferència. Es guarda una referència d\'usuari quan algú cancel·la un esborrament remot programat.';
$string['privacy:metadata:local_coursetransfermanager_executions:deletecancelledat'] = 'Quan es va cancel·lar l\'esborrament programat.';
$string['privacy:metadata:local_coursetransfermanager_executions:deletecancelledby'] = 'Usuari que va cancel·lar l\'esborrament programat a la plataforma origen.';
$string['privacy:metadata:local_coursetransfermanager_prune'] = 'Candidats a la poda de l\'arxiu. Es guarda una referència d\'usuari quan algú exclou una categoria de la poda.';
$string['privacy:metadata:local_coursetransfermanager_prune:excludedat'] = 'Quan es va excloure la categoria de la poda.';
$string['privacy:metadata:local_coursetransfermanager_prune:excludedby'] = 'Usuari que va excloure la categoria de la poda.';
$string['privacy:metadata:local_coursetransfermanager_tasks'] = 'Tasques de transferència configurades en aquest lloc. Es guarden referències d\'usuari per saber qui va crear cada tasca i qui rep els seus avisos.';
$string['privacy:metadata:local_coursetransfermanager_tasks:notifyrecipients'] = 'Usuaris addicionals que reben els avisos d\'aquesta tasca.';
$string['privacy:metadata:local_coursetransfermanager_tasks:usercreated'] = 'Usuari que va crear la tasca. Rep els avisos del seu cicle de vida.';

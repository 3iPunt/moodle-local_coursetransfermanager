...
$string['wz_s1_desc'] = 'Tria la plataforma i comprova quines categories anuals reconeix la màscara abans de desar.';
...
$string['wz_pattern_help'] = 'Màscara de nom de les categories anuals. Aquest curs llegeix «{$a->year}»; l\'anterior, «{$a->previous}».';
$string['wz_pattern_help_invalid'] = 'La màscara necessita un marcador d\'any ({YEAR} o {YY}); sense ell la rotació no pot distingir un curs d\'un altre.';
$string['wz_insert'] = 'Inserir:';
$string['wz_token_year'] = 'any de quatre xifres ({$a})';
$string['wz_test_pattern'] = 'Provar màscara a l\'origen';
$string['wz_pat_loading'] = 'Preguntant a la plataforma origen…';
$string['wz_pat_ok'] = 'L\'origen reconeix {$a} categories anuals';
$string['wz_pat_ok_hint'] = 'La rotació llegeix tota aquesta sèrie: les més recents es queden a l\'origen i les més antigues viatgen a l\'arxiu.';
$string['wz_pat_none'] = 'Cap categoria de l\'origen encaixa amb aquesta màscara';
$string['wz_pat_none_hint'] = 'Aquest curs la màscara llegeix «{$a}». Revisa els idnumber de l\'origen o ajusta la màscara: si deses així, la tasca no arxivarà res.';
$string['wz_pat_down'] = 'L\'origen no respon';
$string['wz_pat_down_hint'] = 'Pot haver caducat el testimoni o estar caigut el lloc. Revisa la plataforma a CourseTransfer i torna a provar. Detall: {$a}';
$string['wz_pat_invalid'] = 'La màscara no és utilitzable';
$string['wz_pat_more'] = 'I {$a} categories reconegudes més.';
$string['wz_pat_courses'] = 'cursos';
$string['wz_pat_invalid_hint'] = 'Ha de portar un marcador d\'any ({YEAR} o {YY}) i, si en porta dos, han de ser anys consecutius.';
$string['wz_token_nextyy'] = 'any següent, dues xifres ({$a})';
$string['wz_token_yy'] = 'any de dues xifres ({$a})';
$string['wz_token_nextyear'] = 'any següent, quatre xifres ({$a})';
...
$string['wz_dest_preview_line'] = 'Categories anuals com «{$a}» (una per curs acadèmic)';
...
$string['wz_ret_archive_box'] = 'L\'arxiu conserva {$a->years} cursos acadèmics més, ja fora de producció. {$a->cutoff} i anteriors passen a ser candidats a poda, amb {$a->grace} dies de gràcia per excloure\'ls: un curs sobreviu {$a->total} anys en total.';
$string['wz_lifecycle_desc'] = 'Projecció de la regla de dalt, perquè ningú s\'hagi d\'imaginar què s\'esborrarà d\'aquí a quatre anys. Es recalcula en directe amb el mateix motor.';
$string['wz_lifecycle'] = 'Què passa, any rere any';
$string['wz_ret_policy_box'] = 'L\'origen conserva {$a->years} cursos acadèmics: {$a->kept}. En aquesta execució la tasca arxivaria {$a->archiving} («{$a->idnumber}») i després l\'eliminaria de l\'origen.';
$string['wz_ret_policy_desc'] = 'Aquesta és la regla que dispara tot la resta: l\'origen conserva els cursos més recents i la tasca arxiva els que surten d\'aquesta finestra. Si la canvies, totes les dates de sota es mouen amb ella.';
$string['wz_ret_policy'] = 'Quants cursos acadèmics es queden en producció';
...
$string['wz_rev_ret'] = '{$a->production} cursos en producció · {$a->days} dies a l\'origen · {$a->years} anys d\'arxiu';
...
// Plantilla de nomenclatura (rotació 2.1).
$string['maskempty'] = 'La plantilla de nomenclatura no pot estar buida.';
$string['masknoyear'] = 'La plantilla de nomenclatura ha de contenir com a mínim un marcador d\x27any, com {YEAR}.';
$string['maskduplicatedyear'] = 'La plantilla de nomenclatura repeteix el mateix marcador d\x27any.';
$string['maskinvalid'] = 'No s\x27ha pogut interpretar la plantilla de nomenclatura.';

// Política de conservació (rotació 2.1).
$string['setting_academicyearstartmonth'] = 'Mes d\x27inici del curs acadèmic';
$string['setting_academicyearstartmonth_desc'] = 'Es fa servir per saber quin curs acadèmic està en marxa quan s\x27executa una tasca. Abans d\x27aquest mes el curs en marxa segueix essent l\x27anterior: al maig del 2026 el curs és 2025/26.';
$string['setting_maxarchivepertick'] = 'Categories arxivades per execució';
$string['setting_maxarchivepertick_desc'] = 'Límit de categories que una tasca arxiva en una sola execució. La resta esperen a la següent, de manera que posar-se al dia amb diversos cursos alhora no saturi les dues plataformes.';
$string['originkeepyears'] = 'Cursos acadèmics a conservar a l\x27origen';
$string['originkeepyears_help'] = 'Quants cursos romanen a la plataforma origen, comptant l\x27actual. Amb 2 es queden el curs actual i l\x27anterior; el més antic s\x27arxiva aquí i després s\x27elimina de l\x27origen.';
$string['lc_invalid'] = 'La projecció necessita una màscara vàlida i com a mínim un any en producció i un a l\'arxiu.';
$string['lc_foot'] = 'Tot esborrat s\'avisa per endavant i es pot cancel·lar; res s\'elimina sense avís previ.';
$string['lc_total'] = 'Un curs sobreviu {$a} cursos acadèmics en total.';
$string['lc_next'] = 'Propera execució';
$string['lc_deleted'] = 'Eliminat definitivament';
$string['lc_archive'] = 'A l\'arxiu';
$string['lc_production'] = 'En producció';
$string['lc_run'] = 'Execució de';
$string['lc_caption'] = 'Projecció des del curs en marxa ({$a}). Els anys en gris encara no existeixen.';
$string['destinationkeepyears_v'] = 'Cursos acadèmics a conservar en aquest arxiu';
$string['destinationkeepyears_v_help'] = 'Quants cursos es conserven aquí un cop arxivats. Juntament amb els anys a l\x27origen determinen quan s\x27elimina definitivament: anys a l\x27origen + anys a l\x27arxiu.';
$string['card_view_executions'] = 'Veure execucions';
$string['card_never_run'] = 'Encara no s\x27ha executat';
$string['card_policy'] = 'Conserva {$a->origin} any(s) a l\x27origen i {$a->archive} a l\x27arxiu';
$string['wz_years_invalid'] = 'Les dues finestres necessiten com a mínim un curs acadèmic: amb un zero la política no significa res i no s\'arxivaria ni podaria res.';
$string['card_view_task'] = 'Veure cicle de vida';
$string['view_title'] = 'Cicle de vida de la tasca';
$string['view_desc'] = 'Tot el que farà aquesta tasca en una pantalla: la política, la propera execució pas a pas i els anys que esborrarà.';
$string['view_policy'] = 'La regla en vigor';
$string['view_policy_line'] = 'Màscara <code>{$a->pattern}</code> · {$a->origin} cursos acadèmics en producció · {$a->archive} a l\'arxiu · un curs sobreviu {$a->total} anys.';
$string['view_next'] = 'La propera execució, pas a pas';
$string['view_next_none'] = 'La tasca està en pausa: no s\'executarà res fins que la tornis a activar.';
$string['view_lifecycle'] = 'Què passa, any rere any';
$string['view_agenda'] = 'Ja programat';
$string['view_agenda_none'] = 'Res programat: cap restauració en marxa i cap esborrat pendent.';
$string['view_archive'] = 'A l\'arxiu ara mateix';
$string['view_archive_none'] = 'La categoria d\'arxiu encara no té cap categoria anual gestionada per aquesta tasca.';
$string['view_adoptable'] = 'Categories que la tasca no gestiona';
$string['view_adoptable_desc'] = 'Encaixen amb la màscara però van arribar a l\'arxiu sense aquesta tasca, així que la poda les ignora a propòsit. Adopta\'n una només si vols que aquesta tasca l\'esborri quan li toqui.';
$string['view_adoptable_none'] = 'No n\'hi ha cap: totes les categories anuals de l\'arxiu les va portar aquesta tasca.';
$string['view_adopt'] = 'Adoptar';
$string['view_unadopt'] = 'Deixar de gestionar';
$string['view_adopted'] = 'Adoptada';
$string['view_adopt_confirm'] = 'Adoptar «{$a}»? A partir d\'aquí aquesta tasca podrà esborrar-la quan la política ho indiqui. Sempre s\'avisarà per endavant.';
$string['view_unadopt_confirm'] = 'Deixar de gestionar «{$a}»? La tasca no la tocarà: la poda mai l\'esborrarà.';
$string['view_courses'] = '{$a} cursos';
$string['view_edit'] = 'Editar la tasca';
$string['adopted_by'] = 'Adoptada per {$a->name} el {$a->date}';
$string['unadopted_by'] = 'Alliberada per {$a->name} el {$a->date}';
$string['adoptnotallowed'] = 'Aquesta categoria no és a l\'arxiu d\'aquesta tasca, així que no es pot adoptar.';

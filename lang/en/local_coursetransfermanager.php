...
$string['privacy:metadata:local_coursetransfermanager_executions'] = 'Executions of the transfer tasks. A user reference is kept when someone cancels a scheduled remote deletion.';
$string['privacy:metadata:local_coursetransfermanager_executions:deletecancelledat'] = 'When the scheduled deletion was cancelled.';
$string['privacy:metadata:local_coursetransfermanager_executions:deletecancelledby'] = 'The user who cancelled the scheduled deletion in the origin platform.';
$string['privacy:metadata:local_coursetransfermanager_prune'] = 'Archive pruning candidates. A user reference is kept when someone excludes a category from pruning.';
$string['privacy:metadata:local_coursetransfermanager_prune:excludedat'] = 'When the category was excluded from pruning.';
$string['privacy:metadata:local_coursetransfermanager_prune:excludedby'] = 'The user who excluded the category from pruning.';
$string['privacy:metadata:local_coursetransfermanager_tasks'] = 'Transfer tasks configured in this site. User references are kept to know who created each task and who receives its notifications.';
$string['privacy:metadata:local_coursetransfermanager_tasks:notifyrecipients'] = 'Additional users that receive the notifications of this task.';
$string['privacy:metadata:local_coursetransfermanager_tasks:usercreated'] = 'The user who created the task. Receives its lifecycle notifications.';

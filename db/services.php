...
$functions = [
    ...
    'local_coursetransfermanager_policy_preview' => [
        'classname' => wizard_external::class,
        'methodname' => 'policy_preview',
        'description' => 'Project the retention policy year by year for the wizard table.',
        'type' => 'read',
        'ajax' => true,
        'capabilities' => 'local/coursetransfermanager:managetasks',
    ],
    ...
    'local_coursetransfermanager_set_adoption' => [
        'classname' => task_external::class,
        'methodname' => 'set_adoption',
        'description' => 'Put an archive category under this task pruning, or take it out.',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'local/coursetransfermanager:managetasks',
    ],
